...
class _HomePageState extends State<HomePage> {
  int _currentIndex = 0;
  String valueChoose = 'Apartment';
  List<String> category = ['Apartment', 'Villa', 'Medical', 'Commercial','Administrative'];
                ...
                children: [
                  DropdownButton(
                    ...
                    onChanged: (value) {
                      ...
                      items: category.map((itemTwo) {
                      return DropdownMenuItem(
                          value: itemTwo, child: Text(itemTwo));
                  ...
                  TextFormField(
                    decoration: const InputDecoration(
                     ...
                     hintText: 'Cash , Installment , Cash or Installment' ,
                      errorBorder: OutlineInputBorder(
                          borderSide: BorderSide(color: Colors.red, width: 5)),
                    ),
                  ),
